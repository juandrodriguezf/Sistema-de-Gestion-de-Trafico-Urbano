"""
traffic_light_controller.py - Traffic Light State Manager for PC2.
...
class TrafficLightController:
    ...
    def change_light(self, semaforo_id: str, nuevo_estado: str, razon: str, origen: str):
        """Cambia el estado de un semáforo y registra la acción."""
    ...
    def run(self):
        ...
        # SUB socket: receive commands from Analytics
        ...
        logger.info(f"Subscribed to light commands at tcp://{pc2_host}:{self.ports['analytics_to_lights']}")
